import { gradeFromDeltaPct, type Grade } from '@/lib/grades'
...
export function analyzeRoster(inputNames:string[], dataset:Dataset, settings:LeagueSettings=DEFAULT_SETTINGS):Analysis{
